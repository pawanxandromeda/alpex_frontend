...
const CreditorList = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (value) => {
                ...
                return (
                    <span
                        className={`rounded-full border px-2 py-1 text-xs font-medium ${colorClasses[value] || 'border-gray-200 bg-gray-100 text-gray-800'}`}
                    >
                        {value}
                    </span>
                )
    ...
    return (
        <div className="container mx-auto min-h-screen bg-gray-100">
            <Header
                heading="Creditor List"
                description="Manage your creditors and their transactions"
                buttonName={
                    <>
            ...
            <DialogBox
                ...
                title={
                    dialogMode === 'add' ? 'Add Creditor' : 'Update Creditor'
                }
